...
public class CarWait extends AppCompatActivity {
    Button btn_wait;
    String email,ID;
    ...
    private void firebaseLocation() {
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    Toast.makeText(CarWait.this, "Driver Found", Toast.LENGTH_SHORT).show();
                    ref.removeEventListener(this);
                    AcceptedRequests requests = snapshot.getValue(AcceptedRequests.class);
                    finish();
                    ref.removeValue();
                    Intent intent = new Intent(CarWait.this, PassengerRideTrack.class);
                    Gson gson = new Gson();
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(CarWait.this, "" + error, Toast.LENGTH_SHORT).show();
            }
        });
    }
    private void initComponents() {
        btn_wait = findViewById(R.id.b_cancelWaitCar);
